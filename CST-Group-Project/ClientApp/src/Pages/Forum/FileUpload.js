...
/*
	...
	This is specifically to upload media for resources.
*/
...
class FileUploadComponent extends Component {
	...
	onFormSubmit(e){
		...
		this.uploadDocuments().then((response)=>{
		})
	}
	...
	uploadDocuments() {
		...
		return post( "/api/Media/Upload?topicId=" + this.props.topic_id, data, config);
	}
